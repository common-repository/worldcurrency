...
Uses IP2C (http://firestats.cc/wiki/ip2c) to determine the country of a visitor
...
EOT;
	...
	// Create the options page
		function dt_wc_adminPage() {
			...
			add_filter( 'plugin_action_links_' . plugin_basename(__FILE__), 'worldcurrency_add_action_links' );
			function worldcurrency_add_action_links ( $links ) {
			 $mylinks = array(
			 '<a href="' . admin_url( 'options-general.php?page=worldcurrency-admin.php' ) . '">Settings</a>',
			 );
